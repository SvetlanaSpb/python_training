...
class ContactHelper:
        ...
        if self.contact_cache is None:
            ...
            for row in wd.find_elements_by_name("entry"):
                ...
                self.contact_cache.append(
                    New(firstname=firstname, lastname=lastname, id=id, all_phones_from_home_page=all_phones,
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return New(firstname=firstname, lastname=lastname, homephone=homephone, mobilephone=mobilephone, workphone=workphone, secondaryphone=secondaryphone,
